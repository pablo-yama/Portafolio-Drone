    ...
    tiers: [
      {
        ...
        price: 4500,
        currency: 'MXN',
        description: 'Cobertura puntual de 2 horas',
        deliverables: [
      ...
      },
      {
        ...
        price: 11500,
        currency: 'MXN',
        description: 'Cobertura de 4-5 horas',
        deliverables: [
          'Cobertura de 4-5 horas continuas',
          '30-40 fotografías editadas',
          'Video highlights de 2-3 min en 4K',
      ...
      },
      {
        ...
        price: 22500,
        currency: 'MXN',
        description: 'Día completo de cobertura',
        deliverables: [
          'Cobertura hasta 8 horas',
          '60+ fotografías editadas',
          'After movie de 3-5 min en 4K',
    ...
    tiers: [
      {
        ...
        price: 5500,
        currency: 'MXN',
        description: 'Diagnóstico puntual de 1 jornada',
        deliverables: [
          'Inspección visual hasta 4 horas',
          '40+ fotografías georreferenciadas',
          'Clip de avance de 60-90 seg',
      ...
      },
      {
        ...
        price: 14500,
        currency: 'MXN',
        description: 'Seguimiento mensual de obra o predio',
        deliverables: [
      ...
      },
      {
        ...
        price: 28000,
        currency: 'MXN',
        description: 'Levantamiento fotogramétrico completo',
        deliverables: [
